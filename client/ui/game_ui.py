...
class ChessApp:
    ...
    def main_menu(self):
        ...
        self.create_button(frame, "🏆 Bảng Xếp Hạng", self.leaderboard_frame).pack(pady=5)
    ...
    def _handle_leaderboard_data(self, resp):
        """Xử lý dữ liệu leaderboard từ server
        ...
        try:
            ...
            if self.leaderboard_ui:
                self.leaderboard_ui.show_error("Không thể tải dữ liệu")
